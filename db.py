...
actualities = Table(
    ...
    Column('wind_direction', String, length=255),
    Column('wind_strength', String, length=255),
...
futures = Table(
    ...
    Column('id', Integer, primary_key=True),
    Column('district', String, length=255),
    Column('temperature', String, length=255),
    Column('weather', String, length=255),
    Column('weather_id_fa', String, length=255),
    Column('weather_id_fb', String, length=255),
    Column('wind', String, length=255),
